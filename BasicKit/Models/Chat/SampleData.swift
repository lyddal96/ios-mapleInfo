...
//        case Audio
    ...
    let messageImages: [UIImage] = [#imageLiteral(resourceName: "event_list_img"), #imageLiteral(resourceName: "ios_app_icon")]
    let emojis = [
        "👍",
        "😂😂😂",
        "👋👋👋",
...
//            return MockMessage(audioURL: soundURL, user: user, messageId: uniqueID, date: date)
    ...
    func getAvatarFor(sender: SenderType) -> Avatar {
        ...
        case "000001":
            return Avatar(image: #imageLiteral(resourceName: "logo"), initials: initials)
        case "000002":
